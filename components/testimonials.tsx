      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-6'>
        ...
        <div>
          ...
          <div className='max-w-3xl mx-auto text-center pb-12 md:pb-20'>
            ...
            <p className='text-xl text-gray-400'>We work with clients from around the world in every business sector.</p>
            <p className='text-xl text-gray-400 my-3'>We&apos;re proud to be rated 4.5 stars on Trustpilot</p>
            <div className='flex justify-center items-center'>
              <Image src='/images/trustpilot.png' alt='Strive on Trustpilot' width={300} height={43} />
            </div>
          </div>
