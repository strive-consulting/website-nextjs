      ...
      <div className='md:hidden flex justify-end bg-gray-900 shadow-md pb-2 w-full px-4'>
        ...
        >
          <ul className='bg-gray-800 px-4 py-2'>
            <li key='menu-1'>
              <button className='flex items-center justify-between w-full flex text-gray-300 hover:text-gray-200 py-4' onClick={handleNestedMenuToggle}>
   ...
   <li>
    ...
    {footer.data.company_items.map((item) => {
     return (
      ...
      <FloatingButton alignment={'mobile'} />
    </>
  )
}
