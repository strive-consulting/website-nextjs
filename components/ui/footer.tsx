          ...
          <div className='grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12'>
            ...
            <div className='md:col-span-4 lg:col-span-5'>
              ...
              <div className='text-gray-400'>
                Strive specialises in Dubai company formation and residency with service at its
                core. Strive Consultants are your trusted advisors when it comes to company
                structuring and formations in Dubai and across the UAE, along with with business
                support, corporate banking, UAE residency and other PRO services.
              </div>
            </div>
