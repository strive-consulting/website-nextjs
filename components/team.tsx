        ...
        <div className='py-12 md:py-20 border-t border-gray-800'>
          ...
          <div className='max-w-3xl mx-auto text-center pb-12 md:pb-20'>
            ...
            <p className='text-xl text-gray-400'>
              Our leadership team comprises accomplished entrepreneurs with a rich international
              background spanning the United Kingdom, Middle East, and Australia
            </p>
          </div>
