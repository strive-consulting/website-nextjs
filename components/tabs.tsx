          ...
          <div>
            ...
            <div className="flex flex-wrap justify-center -m-2" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-tabs]">
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Company Formation</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Residency Visas</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Accountancy</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Banking</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Relocation</span>
              </button>
            </div>
