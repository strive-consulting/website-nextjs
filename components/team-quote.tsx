    ...
    <div className='flex items-center justify-center px-5 py-5 '>
      <div className='w-full mx-auto rounded-lg bg-gray-800 shadow-lg px-5 pt-5 pb-7 text-gray-800'>
        <div className='w-full pt-1 pb-5'>
          <div className='-mt-20 mx-auto flex justify-center'>{avatar && <PrismicNextImage field={avatar} className='rounded-full' width={100} height={100} />}</div>
        </div>
        <blockquote className='text-lg text-gray-400 grow relative'>
          <PrismicRichText
            field={quote}
            components={{
              paragraph: ({ children }) => <p className='text-lg text-gray-400 grow relative'>{children}</p>,
            }}
          />
        </blockquote>
