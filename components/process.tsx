      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-10 pb-12 md:pt-16 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4" data-aos="fade-up">What We Do</h2>
            <p className="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200">Committed to provide you with a wide range of services to facilitate your setup in the UAE</p>
          </div>
