...
export default function Blocks({ title, subTitle, blocks }: BlockProps) {
  const gridItems = blocks?.map((block) => {
    ...
    return (
      <div key={title} className='relative flex flex-col items-center' data-aos='fade-up' data-aos-anchor='[data-aos-id-blocks]'>
        ...
        {block.ctaLink && (
          <Link className='btn-sm text-white bg-purple-600 hover:bg-purple-700 mt-6' href={block.ctaLink} target='_blank'>
      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-6'>
        ...
        <div className=''>
          ...
          <div className='max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none' data-aos-id-blocks>
            ...
            >
              {selectedIcon.icon}
              <h4 className="h4 mb-2">{blocks[0].title}</h4>
