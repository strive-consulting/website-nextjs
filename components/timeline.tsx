      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-6'>
        <div className='py-12 md:py-20'>
          ...
          <div className='max-w-3xl mx-auto text-center pb-12 md:pb-20'>
            <h2 className='h2 mb-4'>Bringing the worlds ideas to life</h2>
            ...
            >
              <div className='pl-2'>
                ...
                <p className='text-lg text-gray-400'>
                  Pretium lectus quam id leo. Urna et pharetra pharetra massa massa. Adipiscing enim
                  eu neque aliquam vestibulum morbi blandit cursus risus.
                </p>
              </div>
            </div>
