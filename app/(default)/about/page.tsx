  ...
  return (
    <>
      <HeroMain
        ...
        backgroundImagePath='/images/about-hero.jpg'
          ...
          <div className='py-12 md:py-20'>
            <div className='max-w-3xl mx-auto text-center pb-12 md:pb-20'>
              ...
              <p className='text-xl text-gray-400'>
                At Strive we try to put service ahead of anything else. We focus on quality of
                service rather than the quantity of clients that we take on board. Providing clear
                and transparent information to clients is what we feel makes us unique.
              </p>
