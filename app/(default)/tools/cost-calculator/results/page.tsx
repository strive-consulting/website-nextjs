              ...
              <div className={`w-full mx-auto`}>
                ...
                <div className='max-w-3xl mx-auto px-4 sm:px-6 relative'>
                  <div className='mt-10 pb-5'>
                    <div className='w-full md:w-3/4 mx-auto border-purple-200 border-4 rounded p-5 mb-5 text-center' data-aos='fade-up' data-aos-delay='200'>
                      <p className='mb-2'>
                        <span className='text-purple-600'>{businessActivityName}</span> business licence and <span className='text-purple-600'>{visaCount} residence visa(s)</span>
                      </p>
