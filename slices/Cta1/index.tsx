          ...
          <div className='relative bg-purple-600 py-10 px-8 md:py-16 md:px-12' data-aos='fade-up'>
            ...
            <div className='relative flex flex-col lg:flex-row justify-between items-center'>
              ...
              <div className='w-full lg:w-1/2'>
                <div className='flex flex-col sm:flex-row justify-end max-w-xs mx-auto sm:max-w-md lg:max-w-none'>
                  {/* <a className='btn text-purple-600 bg-purple-100 hover:bg-white shadow' href='#0'>
                    {slice.primary.cta_text}
                  </a> */}

                  <PrismicNextLink
                    className={`${slice.primary.cta_id} btn text-purple-600 bg-purple-100 hover:bg-white shadow`}
