 ...
 * Props for `SocialBar`.
 */
export type SocialBarProps = SliceComponentProps<Content.SocialBarSlice>

/**
 * Component for "SocialBar" Slices.
 */
const SocialBar = ({ slice }: SocialBarProps): JSX.Element => {
  return (
    <section>
      <div className='max-w-6xl mx-auto px-4 sm:px-6'>
        <Divider halfPadding={true} />
        <div className='md:flex md:items-center md:justify-center pb-3 md:pb-8'>
          <ul className='flex mb-4 md:order-1 md:ml-4 md:mb-0'>
            <li className='mt-2 h5'>Follow us</li>
            <li className='ml-4'>
              <Link
            ...
            <li className='ml-4'>
              ...
              >
                ...
                <svg xmlns='http://www.w3.org/2000/svg' className='w-12 h-12 fill-current youtube-icon' viewBox='0 0 32 32'>
            ...
            <li className='ml-4'>
              <Link
                ...
                aria-label='TikTok'
              >
                <svg xmlns='http://www.w3.org/2000/svg' className='w-12 h-12 fill-current tiktok-icon' width='32px' height='32px' viewBox='0 0 32 32' version='1.1'>
